...
from src.labelmeConfig import get_config
from src.label_file import LabelFile
from src.label_file import LabelFileError
from src.logger import logger
from src.shape import Shape
from src.widgets import BrightnessContrastDialog
from src.widgets import Canvas
from src.widgets import LabelDialog
from src.widgets import LabelListWidget
from src.widgets import LabelListWidgetItem
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        self.count_label = QtWidgets.QLabel("显示标注数量")
        fileListLayout.addWidget(self.count_label)
    ...
    def toolbar(self, title, actions=None):
        ...
        if actions:
            src.addActions(toolbar, actions)
    ...
    def brightnessContrast(self, value):
        dialog = BrightnessContrastDialog(
            src.img_data_to_pil(self.imageData),
    ...
    def openPrevImg(self, _value=False):
        ...
        if currIndex - 1 >= 0:
            ...
            self.count_label.setText(
                " 当前所在位置%d,总数%d" % (currIndex, len(self.imageList)))
            if filename:
                self.loadFile(filename)
    ...
    def openNextImg(self, _value=False, load=True):
        ...
        if self.filename is None:
            ...
            self.count_label.setText(
                " 当前所在位置%d,总数%d" % (currIndex + 2, len(self.imageList)))
        self.filename = filename
